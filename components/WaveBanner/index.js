...
export default function WaveBanner({ serviceSelectorRef, featureRef }) {
    ...
    return (
        <section style={{ backgroundColor: `#FF3CAC`, background: `linear-gradient(225deg, #2B86C5 0%, #784BA0 50%, #FF3CAC 100%)` }}>
            ...
            <div className="md:mx-left lg:absolute lg:left-20 flex justify-start">
            ...
            <div className="text-center">
                <p className="lg:text-3xl text-sm font-medium text-center ">The premium <a href="#" className="text-primary">all-in-one</a> SMS number provider</p>
                <p className="lg:text-md text-xs font-thin mt-2 ">Effortlessly purchase affordable phone numbers with our user-friendly, elegant interface. </p>
            </div>
            ...
            <div className="lg:absolute right-20 mt-3">
